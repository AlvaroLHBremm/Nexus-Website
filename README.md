...
O host Infinityfree não permite com facilidade a requisição de dados diretamente ao website como uma API. Para circunver esta limitação foi criado uma vertente do website que requisita os dados localmente, deste modo os "desafios" propostos pelo website seriam executados naturalmente pelo browser 
